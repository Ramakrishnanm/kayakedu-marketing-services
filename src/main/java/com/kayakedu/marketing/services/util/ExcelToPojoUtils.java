package com.kayakedu.marketing.services.util;
...
public class ExcelToPojoUtils {
    ...
    public static <T> List<T> toPojo(Class<T> type, String input) throws IOException {
        List<T> results = new ArrayList<>();
        Workbook workbook = WorkbookFactory.create(new FileInputStream(input));
